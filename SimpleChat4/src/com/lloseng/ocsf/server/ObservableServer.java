...
/**
 * This class acts as a subclass of <code>AbstractServer</code> and is also an <code>Observable</code> class. This means that when a message is received, all observers are notified.
 * 
...
public class ObservableServer extends Observable {
	...
	/**
	 * The string sent to the observers when an exception occurred with a client. The error message of that exception will be appended to this string.
	 */
	public static final String CLIENT_EXCEPTION = "#OS:Client exception.";

	/**
	 * The string sent to the observers when a listening exception occurred. The error message of that exception will be appended to this string.
	 */
	...
	/**
	 * Returns an array of containing the existing client connections. This can be used by concrete subclasses to implement messages that do something with each connection (e.g. kill it, send a
	 * message to it etc.)
	 * 
	...
	final public String getUserList() {
		return service.getUserList();
	}

	/**
	 * Hook method called each time a new client connection is accepted. The method may be overridden by subclasses.
	 * 
	 * @param client
	...
	/**
	 * Hook method called each time an exception is raised in a client thread. This implementation simply closes the client connection, ignoring any exception. The method may be overridden by
	 * subclasses.
	 * 
	 * @param client
	...
	/**
	 * This method is called when the server stops accepting connections because an exception has been raised. This implementation simply calls <code>stopListening</code>. This method may be overriden
	 * by subclasses.
	 * 
	 * @param exception
	 *            the exception raised.
	...
	/**
	 * This method is called when the server stops accepting connections for any reason. This method may be overriden by subclasses.
	 */
	...
	/**
	 * This method is called when the server starts listening for connections. The method may be overridden by subclasses.
	 */
	...
	/**
	 * This method is used to handle messages coming from the client. Observers are notfied by receiveing the transmitted message. Note that, in this implementation, the information concerning the
	 * client that sent the message is lost. It can be overriden, but is still expected to call notifyObservers().
	 * 
	 * @param message
